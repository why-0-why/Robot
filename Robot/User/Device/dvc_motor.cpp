 ...
 */
void Class_Motor_GM6020::Init(CAN_HandleTypeDef* hcan, Enum_CAN_Motor_ID __CAN_ID, Enum_Control_Method __Control_Method,
 ...
 */
void Class_Motor_C610::Init(CAN_HandleTypeDef* hcan, Enum_CAN_Motor_ID __CAN_ID, Enum_Control_Method __Control_Method,
 ...
 * @param __Torque_Max 最大扭矩, 需根据不同负载测量后赋值, 也就开环和扭矩环输出用得到, 不过我感觉应该没有奇葩喜欢开环输出这玩意
 */
void Class_Motor_C620::Init(CAN_HandleTypeDef* hcan, Enum_CAN_Motor_ID __CAN_ID, Enum_Control_Method __Control_Method,
                            float __Gearbox_Rate, float __Torque_Max)
{
    if (hcan->Instance == CAN1)
    {
