...
extern uint32_t BMI088_get_sensor_time(void);
extern float BMI088_get_temperate(void);
extern void BMI088_get_gyro(int16_t gyro[3]);
extern void BMI088_get_accel(float accel[3]);
